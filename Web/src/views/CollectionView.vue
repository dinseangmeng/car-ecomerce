            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <img class="d-block w-50 m-auto" src="../assets/img/car_product/ferrari.png" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-50 m-auto" src="../assets/img/car_product/old_school.png" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-50 m-auto" src="../assets/img/car_product/fortuner.png" alt="Third slide">
                    </div>
                </div>
